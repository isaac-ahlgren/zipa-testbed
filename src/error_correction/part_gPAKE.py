...
class GPAKE:
    ...
    def handle_device_public_key_exchange(self, conn, priv_key, password, device_id):
        ...
        return self.generate_shared_key(priv_key, device_pub_key_bytes, device_id, device_id_received)
    ...
    def handle_host_public_key_exchange(self, conn, priv_key, pub_key, password, device_id, session_idx):
        ...
        return self.generate_shared_key(priv_key, host_pub_key_bytes, device_id, host_device_id)
