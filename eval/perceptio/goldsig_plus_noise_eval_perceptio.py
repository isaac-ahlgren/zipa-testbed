...
def goldsig_eval(
    ...
    for i in range(trials):
        signal_events, signal_event_features = gen_min_events(golden_signal, chunk_size, min_events, top_th, bottom_th, lump_th, a, add_noise=True, snr=snr_level)
        adv_events, adv_event_features = gen_min_events(adversary_signal, chunk_size, min_events, top_th, bottom_th, lump_th, a, add_noise=True, snr=snr_level)
