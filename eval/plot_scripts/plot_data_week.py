...
def load_bytes(byte_file):
   """
   Loads bits from a file and returns them as a list of strings.
   Adds error handling in case the file is not found.
   """
   try:
       ...
       print(f"File {byte_file} not found.")
       return []
...
if __name__ == "__main__":
   ...
   plot_ber_comparisons(legit_comparison, adv_comparison, custom_plot_filename="custom_ber_comparison_plot_week.pdf")


   # Save the BER data to a custom CSV file
   save_to_csv(legit_comparison, adv_comparison, custom_csv_filename="custom_ber_comparison_data_week.csv")