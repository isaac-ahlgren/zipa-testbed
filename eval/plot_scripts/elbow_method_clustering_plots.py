...
def clustering_data(wrapper, cluster_size, max_cluster_size):
    X, _ = make_blobs(n_samples=300, centers=cluster_size, cluster_std=0.05, random_state=0)
...
def main():
    ...
    plot_cluster_scores(cluster1_scores_iot, filename="./plot_data/iotcupid_cluster1.png")

    cluster2_scores_iot = clustering_data(iotcupid_wrapper, 2, MAX_CLUSTER_SIZE)
    plot_cluster_scores(cluster2_scores_iot, filename="./plot_data/iotcupid_cluster2.png")

    cluster3_scores_iot = clustering_data(iotcupid_wrapper, 3, MAX_CLUSTER_SIZE)
    plot_cluster_scores(cluster3_scores_iot, filename="./plot_data/iotcupid_cluster3.png")

    cluster1_scores_perc = clustering_data(perceptio_wrapper, 1, MAX_CLUSTER_SIZE)
    plot_cluster_scores(cluster1_scores_perc, filename="./plot_data/perceptio_cluster1.png")

    cluster2_scores_perc = clustering_data(perceptio_wrapper, 2, MAX_CLUSTER_SIZE)
    plot_cluster_scores(cluster2_scores_perc, filename="./plot_data/perceptio_cluster2.png")

    cluster3_scores_perc = clustering_data(perceptio_wrapper, 3, MAX_CLUSTER_SIZE)
    plot_cluster_scores(cluster3_scores_perc, filename="./plot_data/perceptio_cluster3.png")
