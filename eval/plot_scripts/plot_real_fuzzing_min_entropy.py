...
def min_entropy_devices(devices, contents, param_label, file_name_stub, fig_dir, savefig=True):
    for device in devices:
        ...
        device_file_stub = f"{file_name_stub}_{pairs[0]}_{pairs[1]}_{param_label}_minentropy"
...
def plot_schurmann(savefigs=True):
    ...
    min_entropy_devices(DEVICE_PAIRS, contents, "window_length", SCHURMANN_REAL_FUZZING_STUB, fig_dir, savefig=savefigs)
    min_entropy_devices(DEVICE_PAIRS, contents, "band_length", SCHURMANN_REAL_FUZZING_STUB, fig_dir, savefig=savefigs)
...
def plot_miettinen(savefigs=True):
    ...
    min_entropy_devices(DEVICE_PAIRS, contents, "f_samples", MIETTINEN_REAL_FUZZING_STUB, fig_dir, savefig=savefigs)
    min_entropy_devices(DEVICE_PAIRS, contents, "w_samples", MIETTINEN_REAL_FUZZING_STUB, fig_dir, savefig=savefigs)
    min_entropy_devices(DEVICE_PAIRS, contents, "rel_thr", MIETTINEN_REAL_FUZZING_STUB, fig_dir, savefig=savefigs)
    min_entropy_devices(DEVICE_PAIRS, contents, "abs_thr", MIETTINEN_REAL_FUZZING_STUB, fig_dir, savefig=savefigs)
